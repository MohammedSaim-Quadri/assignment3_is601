# modified the previous function imports to use class and its methods, here we are able to import the class directly and
# use its methods
...
def calculator():
    ...
    while True:
        ...
        '''
         Now we check what operation the user wants and based on that
         we call the right function from the Operations class using dot notation, instead of calling standalone functions.
        '''
        if operation == "add":
